  ...
  return (
    <div className="container" dir="ltr">
      <div className={`left-side ${leftSide ? 'active' : ''}`}>
        <div className="left-side-button" onClick={toggleRightSide}>
          <svg
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth="2"
      ...
      <div className="main">
        <div className="search-bar">
          ...
          <button className="right-side-button" onClick={toggleLeftSide}>
            <svg
              viewBox="0 0 24 24"
              width="24"
              height="24"
      ...
      <div className={`right-side ${rightSide ? 'active' : ''}`}>
        ...
        <div className="side-wrapper stories">
          ...
          <div className="user">
            ...
            <div className="username">
              Gvozden Boskovsky
              <div className="album-date">29 minutes ago</div>
            </div>
          </div>
          <div className="user">
            <img
            ...
            <div className="username">
              Hnek Fortuin
              <div className="album-date">3 hours ago</div>
            </div>
          </div>
          <div className="user">
            <img
            ...
            <div className="username">
              Lubomir Dvorak
              <div className="album-date">18 hours ago</div>
            </div>
          </div>
        </div>
        <div className="side-wrapper contacts">
          ...
          <div className="user">
            ...
            <div className="username">
              Sofia Alcocer
              <div className="user-status idle"></div>
            </div>
          </div>
          <div className="user">
            <img
